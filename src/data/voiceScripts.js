...
export const rewardGuide =
  "¡Nivel superado! Adri está celebrando porque has leído una misión completa.";

export const successFeedback = "¡Bien!";

export const retryFeedback = "¡Repite!";
