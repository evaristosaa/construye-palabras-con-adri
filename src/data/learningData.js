  ...
  return [
    {
      id: `${lesson.id}-letter`,
      title: "Toca la letra",
      prompt: lesson.focus === "vocales" ? "Toca la vocal A" : `Toca la letra ${letter}`,
      type: "choice",
      speak:
        lesson.focus === "vocales"
          ? "Soy Adri. Mira los bloques y toca la vocal A. Si no sale a la primera, no pasa nada."
          : `Soy Adri. Mira los bloques y toca la letra ${letter}. Yo juego contigo.`,
    ...
    },
    {
      ...
      prompt: "Escucha y toca el bloque",
      type: "choice",
      speak: `Escucha bien. Yo digo ${lesson.syllables[0]}. Ahora toca el bloque que suena igual.`,
    ...
    },
    {
      ...
      prompt: `${letter} + A = ?`,
      type: "choice",
      speak: `Vamos a construir una sílaba. Juntamos ${letter} con A y suena ${lesson.syllables[0]}. Toca ${lesson.syllables[0]}.`,
    ...
    },
    {
      ...
      type: "choice",
      speak: `Mira el dibujo conmigo. ¿Cómo se llama? Toca la palabra ${secondWord.text}.`,
    ...
    },
    {
      ...
      type: "build",
      speak: `Ahora construimos una palabra. Toca los bloques en orden para formar ${firstWord.text}.`,
    ...
    },
    {
      ...
      prompt: phrase,
      type: "phrase",
      speak: `Vamos a leer una frase corta. Escucha primero: ${phrase}. Cuando estés listo, toca el botón verde.`,
      answer: "leida",
      phrase,
      character: "reader",
    },
    {
      id: `${lesson.id}-test`,
      title: "Mini reto",
      prompt: "Mini reto final",
      type: "choice",
      speak: `Último reto. Escucha la palabra ${firstWord.text}. Ahora toca la palabra que está bien escrita.`,
